                ...
                children: [
                  Obx(
                      ...
                      child: Stack(
                        children: [
                          AnimatedAlign(
                            alignment: controller.currentLanguage.value == 'English'
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: GestureDetector(
                                  onTap: () => controller.changeLanguage('Indonesian'),
                                  child: Center(
                                    child: Text(
                                      'Indonesian',
                                      style: TextStyle(
                                        color: controller.currentLanguage.value == 'Indonesian'
                                            ? textColor
                                            : textColor.withOpacity(0.5),
                                        fontWeight: FontWeight.bold,
                                      ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: controller.isAnalyzeEnabled.value
                                  ? textColor
                                  : unactiv,
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(10),
                      ...
                      Obx(() => controller.isResultAvailable.value
                          ? Column(
                        children: [
                          PieChart(
                            ...
                            chartValuesOptions: const ChartValuesOptions(
                              showChartValueBackground: false, // Menghilangkan background putih
                              showChartValues: true,
                              showChartValuesInPercentage: true,
                              showChartValuesOutside: false,
                              chartValueStyle: TextStyle(color: Colors.black), // Opsional: mengatur warna teks
                            ),
                          ),
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(16.0),
                          child: Text(
                            controller.translate('result_placeholder'),
                            style: const TextStyle(
                              color: textColor,
                              fontSize: 20,
                            ),
