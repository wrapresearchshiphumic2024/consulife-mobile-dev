...
class DetailWaitingPasienView extends GetView<DetailWaitingPasienController> {
  const DetailWaitingPasienView({super.key});
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 8.0),
                    Text(
                      'Make sure your have a stable internet connection and are in a quiet place during the consultation session.',
                      style: TextStyle(
                        color: textColor,
                        fontSize: 12,
                      ),),
